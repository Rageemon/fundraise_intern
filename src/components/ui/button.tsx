  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-medium ring-offset-background transition-smooth focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        success: "bg-gradient-success text-success-foreground hover:shadow-success hover:scale-105 active:scale-95",
        warning: "bg-gradient-warning text-warning-foreground hover:shadow-warning hover:scale-105 active:scale-95",
        premium: "bg-gradient-primary text-primary-foreground hover:shadow-glow hover:scale-105 active:scale-95 border border-primary/20",
      },
      size: {
